export const blogPosts = [
  {
    ...
    alt: '蓝紫色数字粒子视觉，代表 AI 时代的设计师专业身份',
    caption: '文章讨论的重点不是工具，而是可被验证和复用的专业能力。',
    aspectRatio: '16 / 9',
    mediaType: 'image',
    type: '定位观察',
  ...
  },
  {
    ...
    alt: '发光电路组成的 AI 字样，代表从提示词到交付的数字流程',
    caption: '工作流的价值来自可控、可筛选和可复盘。',
    aspectRatio: '16 / 9',
    mediaType: 'image',
    type: '方法论',
  ...
  },
  {
    ...
    cover: '/avatar.jpg',
    heroMedia: '/avatar.jpg',
    alt: 'Liuli AI Lab 主理人的数字头像',
    caption: '个人知识系统最终需要服务于真实实践与长期积累。',
    aspectRatio: '16 / 9',
    mediaType: 'image',
    type: '知识系统',
