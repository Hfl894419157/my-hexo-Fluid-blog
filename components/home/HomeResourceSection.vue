...
.knowledge-grid span { color: var(--brand-cyan); font-size: 11px; font-weight: 400; letter-spacing: 0.08em; }
...
.knowledge-grid p { margin: 12px 0 20px; color: var(--text-sub); font-size: 12px; font-weight: 400; line-height: 1.75; }
