...
.knowledge-grid span { color: var(--brand-cyan); font-size: var(--text-micro); font-weight: 400; letter-spacing: 0.08em; }
.knowledge-grid h3 { margin: 18px 0 0; color: var(--text-main); font-family: var(--font-sans); font-size: var(--text-compact-title); font-weight: 700; line-height: 1.55; }
.knowledge-grid p { margin: 12px 0 20px; color: var(--text-sub); font-size: var(--text-label); font-weight: 400; line-height: 1.75; }
