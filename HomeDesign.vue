...
@media (max-width: 768px) {
  ...
  .hero-title { font-size: 2.2rem !important; margin-bottom: 15px !important; line-height: 1.2 !important; }
  ...
  .resume-intro h3 { font-size: 1.8rem !important; }
  .resume-intro p { font-size: 1rem !important; }
  .resume-stats { flex-direction: row !important; flex-wrap: wrap !important; justify-content: center !important; gap: 30px !important; margin: 20px 0 !important; }
  .stat-val { font-size: 2.4rem !important; }
  .btn-resume-cta { width: 100% !important; justify-content: center !important; }

  .common-header h3 { font-size: 1.8rem !important; margin: 10px 0 !important; line-height: 1.4 !important; padding-bottom: 5px !important; }
  ...
  .blog-main h4 { font-size: 1.3rem !important; }
